...
class AgentMobileJsonFormatter(logging.Formatter):
...
class AgentMobilePrettyFormatter(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
...
def configure_logging(*, pretty: bool, level: str) -> None:
    ...
    if pretty:
        formatter = AgentMobilePrettyFormatter()
    else:
        formatter = AgentMobileJsonFormatter()
